...
public class MDatabase {
    ...
    public void insertAllSites(int table, ArrayList<VisitData> listMovies, boolean clearPrevious) {
        ...
        for (int i = 0; i < listMovies.size(); i++) {
            ...
            statement.bindString(11, visitData.isDelete() ? "true" : "false");
            statement.bindString(12, visitData.getPropertyname());
            statement.execute();
        }
    ...
    public void deleteBeacon(String sietid) {
    ...
    public void deleteData() {
        mDatabase.delete(SiteHelper.TABLE_ALL, null, null);
        mDatabase.delete(SiteHelper.TABLE_LIKE, null, null);
        mDatabase.delete(SiteHelper.TABLE_OFFER, null, null);
        mDatabase.delete(SiteHelper.TABLE_VISIT, null, null);
        mDatabase.delete(SiteHelper.TABLE_VISITED_BEACON, null, null);
    ...
    public ArrayList<VisitData> getAllSites(int table) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                visitData.setDelete(cursor.getString(cursor.getColumnIndex(SiteHelper.COLUMN_DELETE)).equals("true") ? true : false);
    ...
    private static class SiteHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            try {
                ...
                db.execSQL(" DROP TABLE IF EXISTS " + TABLE_VISITED_BEACON);
                onCreate(db);
            } catch (SQLiteException exception) {
